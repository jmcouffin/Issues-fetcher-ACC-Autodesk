    ...
    with st.sidebar:
        ...
        if st.session_state.authenticated:
            ...
            if st.session_state.hubs:
                ...
                selected_hub_name = st.selectbox("Select Hub:", hub_names, key="hub_selectbox")
                
                # Store selection in session state
                st.session_state.selected_hub_name = selected_hub_name
                ...
                if selected_hub_name:
                    ...
                    if st.session_state.projects:
                        ...
                        selected_project_name = st.selectbox(
                            "Select Project:", project_names, key="project_selectbox"
                        )
